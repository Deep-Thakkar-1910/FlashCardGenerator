...
const ViewCardTerms = ({ viewCardTerms }) => {
  ...
  return (
    ...
    <div className=" flex w-full flex-col gap-10 lg:flex-row lg:items-start lg:justify-between">
      ...
      <div className="flex h-fit w-full justify-center gap-20 overflow-x-scroll rounded-md bg-white px-4  pb-3 pt-6 shadow-md lg:min-h-[30rem] lg:w-2/6  lg:flex-col lg:items-center lg:justify-start lg:gap-5 xl:w-1/6">
